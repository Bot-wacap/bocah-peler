...
* (Scriptnya UwiwBocah).
*/
const BotName = '👾Uwiwbocah👾'; // Nama Bot Whatsapp
...
const grupch2 = 'BELUM ADA KAYA HATI'; // OFFICIAL GRUP LU 2
const grupch3 = 'https://instagram.com/Uwiw_Bocah'; // OFFICIAL GRUP LU 3
//
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] UwiwBocah Ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Uwiw_Bocah.ig`))
...
conn.sendMessage(id, 'Owner UWIWBOCAH wa.me/+6281381630954' ,MessageType.text);
}
else if (text == 'bot'){
conn.sendMessage(id, 'Aku BOT nya UWIWBOCAH ID' ,MessageType.text);
}
...
//Tolonglah bro jangan di ubah ubah Uwiw Bocah
